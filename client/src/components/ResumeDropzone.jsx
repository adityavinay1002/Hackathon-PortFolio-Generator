    ...
    return (
        <div className="w-full">
            {!selectedFile ? (
                ...
                >
                    <input {...getInputProps()} />
                    <div className="w-20 h-20 rounded-full bg-purple-600/10 flex items-center justify-center text-purple-600 mx-auto mb-6 border border-purple-500/20">
                        <Upload size={32} />
                    </div>
                ...
                <div className="bg-white p-6 rounded-[32px] border border-gray-100 shadow-sm flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-purple-600/10 flex items-center justify-center text-purple-600 border border-purple-500/10">
                            <FileText size={24} />
                        </div>
                        <div>
                            <p className="text-gray-900 font-bold truncate max-w-[200px] md:max-w-md">
                                {selectedFile.name}
                            </p>
